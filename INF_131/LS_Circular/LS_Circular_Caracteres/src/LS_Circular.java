...
public class LS_Circular extends ListaSimple {
    ...
    public void mostrar(){
        Nodo R = P;
        while (R.getSig() != P){
            System.out.print(R.getCaracter() + " -> ");
            R = R.getSig();
        }
        System.out.println(R.getCaracter() + " -> (Inicio)");
    }
    ...
    public void llenarFinal(int n) {
        ...
        for (int i = 1; i <= n; i++) {
            System.out.println("\n--- Ingresando Caracter #" + i + " (al Final) ---");
    ...
    public void llenarPrincipio(int n) {
        ...
        for (int i = 1; i <= n; i++) {
            System.out.println("\n--- Ingresando Caracter #" + i + " (al Principio) ---");
            String linea = lee.nextLine();
            char caracter = linea.charAt(0);
            adiPrincipio(caracter);
